pc.extend(pc, function () {
    ...
    var StreamingAudioHandler = function (manager) {
    ...
    StreamingAudioHandler.prototype = {
    ...
    if (pc.SoundManager.hasAudio()) {
         ...
         */
        StreamingAudioHandler.prototype._createSound = function (url, success, error) {
            var audio = null;
    ...
    return {
        StreamingAudioHandler: StreamingAudioHandler
    };
}());
